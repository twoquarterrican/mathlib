...
lemma has_lines_iff_has_points (h : fintype.card c.P = fintype.card c.L) :
  c.has_lines ↔ c.has_points :=
begin
...
structure projective_plane extends has_points c, has_lines c : Prop :=
(nondegenerate : false)-/
